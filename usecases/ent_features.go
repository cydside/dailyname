...
type UserReq struct {
	...
	SingleOrSub bool   `json:"singleorsub"`   // True: A long forlder name per day(eg: 2017-01-22) or a forlder for the year, subfolders for the months and subfolders for the days(default).
